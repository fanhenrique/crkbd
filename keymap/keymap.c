...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //----------------------------------------------------------------    ----------------------------------------------------------------
        XXXXXXX, XXXXXXX, XXXXXXX,    KC_D,    KC_F, KC_MUTE, KC_VOLD,      KC_MICD, KC_MICM, KC_LALT, KC_LSFT, KC_LCTL, KC_DQUO, XXXXXXX,
    //----------------------------------------------------------------    ----------------------------------------------------------------
        KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, KC_V, XXXXXXX,                        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    //----------------------------------------------------------------    ----------------------------------------------------------------
